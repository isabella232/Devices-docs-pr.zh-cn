...
新版 Surface Hub 操作系统通过 Windows 更新发布，就像 Windows10 的各个版本一样。 此页面介绍管理 Surface Hub 设备更新的最佳做法。 

## 适用于企业的 Windows 更新

Windows 更新企业版是一组功能，旨在针对 Windows 更新在 Windows 更新安装时的方式和时间提供更多控制，同时降低设备管理成本。 通过使用此方法，Surface Hub 直接连接到 Microsoft 的 Windows 更新服务。
...
将以下 Windows 更新受信任网站 Url 添加到 "允许列表"：
...
为了确保设备在工作时间内始终可用，Surface Hub 在指定维护窗口期间执行其管理功能。 在 "维护" 窗口期间，Surface Hub 将通过 Windows 更新自动安装更新，并在窗口结束之前的20分钟内重新启动设备。

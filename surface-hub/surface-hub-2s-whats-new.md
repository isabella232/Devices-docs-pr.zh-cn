...
|**功能**|**摘要**|**了解详细信息**|
|:-------|:------|:----|
|**迁移到 Windows 10 专业版或企业版**| Surface Hub 2 是预安装的 Windows 10 团队，它是 Windows 10 的自定义版本，旨在促进会议室环境轻松协作。 现在，你可以选择运行 Windows 10 专业版或企业版来使用 Surface Hub 2，与任何其他电脑非常相似。| [宣布 Surface Hub 2 上的 Windows 10 专业版和企业版的可用性](https://techcommunity.microsoft.com/t5/surface-it-pro-blog/announcing-the-availability-of-windows-10-pro-and-enterprise-on/ba-p/1624107) <br> <br> [迁移到 Surface Hub 2 上的 Windows 10 专业版或企业版](surface-hub-2s-migrate-os.md) |
|**移动设备管理和 UEFI 可管理性**| 使用 (MDM) 提供程序管理 "移动设备管理" 的设置和策略。 <br> <br> 与 Surface Enterprise 管理模式 (SEMM) 的完全集成可让你管理硬件组件和固件。 | [通过 Microsoft Intune 管理 Surface Hub 2](surface-hub-2s-manage-intune.md) <br> <br> [Surface 企业管理模式](https://docs.microsoft.com/surface/surface-enterprise-management-mode) |
...
|**粗细**| 105磅。  (48 公斤)  | 280磅。  (127 公斤)  | 61.6 磅。  (28 公斤)  |
...
|**处理器**| 第4代英特尔®核心 i5 | 第4代英特尔酷睿 i7 | 英特尔®酷睿8处理器英特尔酷睿 i5 处理器 |
...
|**端口**|  (1) USB 3.0 (底部) + (1) USB 3.0 (端访问)   <br>  (2) USB 2。0 <br> DisplayPort 视频输出 <br> 3.5 mm 立体声输出 <br> 用于系统级控制的 RJ11 连接器 <br> <br> DisplayPort 视频输入 <br> HDMI 视频输入 <br> VGA 视频输入 <br> 3.5 毫米立体声输入 <br>  (1) USB 2.0 类型 B Touchback 输出 |  (1) USB 3.0 (底部) + (1) USB 3.0 (端访问)  <br>  (4) USB 2。0 <br> DisplayPort 视频输出 <br> 3.5 mm 立体声输出 <br> 用于系统级控制的 RJ11 连接器 <br> <br> DisplayPort 视频输入 <br> HDMI 视频输入 <br> VGA 视频输入 <br> 3.5 毫米立体声输入 <br>  (1) USB 2.0 类型 B Touchback 输出 |  (1) USB-A <br> 微型 DisplayPort 视频输出 <br> HDMI 视频输入 <br> 带有 DisplayPort 输入的 USB-C <br>  (4) USB-C (显示)  <br> RJ45 千兆位以太网 |
|**传感器**|  (2) 被动红外线状态传感器（环境光传感器） |  (2) 被动红外线状态传感器（环境光传感器） | Doppler 占用传感器， <br> 加速 <br> 陀螺仪  |
|**NFC**| NFC 读卡器 | NFC 读卡器 | 不适用 |
|**扬声器**|  (2) 正面立体扬声器 |  (2) 正面立体扬声器 | 完整范围的正面朝3路立体扬声器 |
|**麦克风**| 高性能、4元素数组 | 高性能、4元素数组 | 完整带8元素 MEMS 麦克风阵列 |
|**相机**|  (2) 宽屏角高清相机 1080p 30 fps |  (2) 宽屏角高清相机 1080p 30 fps |  (1) Microsoft Surface Hub 2 相机、4K、USB-C 连接、90度视图的水平字段                                                           |
|**笔**|  (2) 电源、活动、子像素精度 |  (2) 电源、活动、子像素精度 |  (1) Microsoft Surface Hub 2 笔 (活动)  |

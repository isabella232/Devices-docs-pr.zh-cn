...
|               欢迎屏幕上显示的会议信息                |                                               InBoxApps/Welcome/MeetingInfoOption                                                |                       是                        | 是。<br> [使用自定义设置。]（#example 管理-surface-集线器-microsoft-终结点-配置管理器 |             是             |
...
|                   设备帐户，包括密码轮换                    | DeviceAccount/*`<name_of_policy>`* <br> 请参阅 [SurfaceHub CSP](https://msdn.microsoft.com/library/windows/hardware/mt608323.aspx)。 |                        否                        |                       否                        |             是             |
...
|                       设置                        |                                                          详细信息                                                          |                                                             CSP 参考                                                             |            支持<br>Intune?             |    支持<br>Configuration Manager?     | 支持<br>SyncML\*? |
|------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------|-------------------------------------------------|-----------------------------|
|            立即重新启动设备             | 与 OMS 一起使用，将支持成本降到最低 – 请参阅[监视 Microsoft Surface Hub](monitor-surface-hub.md)。 |        ./Vendor/MSFT/Reboot/RebootNow <br> 请参阅[重启 CSP](https://msdn.microsoft.com/library/windows/hardware/mt720802.aspx)        |                       是                        |                       不可用                        |             是             |
